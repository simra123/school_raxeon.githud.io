...
const FileUpload = ( props) => {
  ...
  return(
    <div className=" grid grid-cols-1  pb-5 px-4 mt-4 " >
        ...
        <label className=" flex-col ring-1 ring-purple-400  text-blue-700 rounded-lg shadow-lg h-60 place-items-center border align-middle flex justify-center cursor-pointer hover:bg-purple-100" >
